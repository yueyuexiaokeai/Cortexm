...
HD_PWD='E:/cortex-m0_example/cortex_m0_seg7/cortex_m0.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log AHBLITE_SYS.vds -m64 -mode batch -messageDb vivado.pb -notrace -source AHBLITE_SYS.tcl
